functions{
  ...
  real mu_star, real mu_0, real mu_1, real gamma_0, real gamma_1, real rho_0, real v_0, real rho_1, real v_1, real rho_01){

    real D_0 = v_0 + (N_0 - 1) * rho_0;
    real D_1 = v_1 + (N_1 - 1) * rho_1;
    real W = D_0 * D_1 - N_0 * N_1 * rho_01 ^ 2;
    real W_0 = W * (rho_0 - v_0);
    real W_1 = W * (rho_1 - v_1);

    // invert the covariance matrix (the inverse will have similar structure)
    real rho_0_i_0 = (N_1 - 1) * rho_0 * rho_1 + rho_0 * v_1 - N_1 * rho_01 ^ 2;
    real rho_0_i = rho_0_i_0 / W_0;
    real delta_0_i = (rho_0_i_0 - W) / W_0;
    real rho_1_i_0 = (N_0 - 1) * rho_0 * rho_1 + rho_1 * v_0 - N_0 * rho_01 ^ 2;
    real rho_1_i = rho_1_i_0 / W_1;
    real delta_1_i = (rho_1_i_0 - W) / W_1;
    real rho_01_i = -1 * rho_01 / W;

    // compute the determinant of the covariance matrix
    real logW = log(W);
    real logdet = logW + (N_0 - 1) * log(v_0 - rho_0) + (N_1 - 1) * log(v_1 - rho_1);
    ...
    real cov_11 = rho_1_i * (C_1 - 2 * mu_1 * (N_1 - 1) * M_1 + N_1 * (N_1 - 1) * mu_1 ^ 2);
    real cov_01 = 2 * rho_01_i * (C_01 - N_0 * mu_0 * M_1 - N_1 * mu_1 * M_0 + N_0 * N_1 * mu_0 * mu_1);
    real logcov = cov_0 + cov_00 + cov_1 + cov_11 + cov_01;

    real D_0_i = delta_0_i + (N_0 - 1) * rho_0_i;
    real D_1_i = delta_1_i + (N_1 - 1) * rho_1_i;
...
for (i in 1:N){
 ...
 mu_star, mu_0_, mu_1_, gamma_0_, gamma_1_, rho_0_, v_0_, rho_1_, v_1_, rho_01_);
}

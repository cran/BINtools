...
namespace model_case_2_1M_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_case_2_1M");
    reader.add_event(108, 106, "end", "model_case_2_1M");
    return reader;
}
template <typename T3__, typename T4__, typename T5__, typename T6__, typename T7__, typename T8__, typename T9__, typename T10__, typename T11__, typename T12__, typename T13__, typename T14__, typename T15__, typename T16__, typename T17__, typename T18__>
typename boost::math::tools::promote_args<T3__, T4__, T5__, T6__, typename boost::math::tools::promote_args<T7__, T8__, T9__, T10__, typename boost::math::tools::promote_args<T11__, T12__, T13__, T14__, typename boost::math::tools::promote_args<T15__, T16__, T17__, T18__>::type>::type>::type>::type
information_diversity_probit_likelihood(const int& N_0,
                                            ...
                                            const T16__& v_0,
                                            const T17__& v_1,
                                            const T18__& rho_01, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T3__, T4__, T5__, T6__, typename boost::math::tools::promote_args<T7__, T8__, T9__, T10__, typename boost::math::tools::promote_args<T11__, T12__, T13__, T14__, typename boost::math::tools::promote_args<T15__, T16__, T17__, T18__>::type>::type>::type>::type local_scalar_t__;
    ...
    try {
        ...
        stan::math::assign(rho_0_i_0,((rho_0 * v_1) - (N_1 * pow(rho_01, 2))));
        ...
        stan::math::assign(delta_1_i,((v_0 + ((N_0 - 1) * rho_0)) / W));
        ...
        stan::math::assign(logcov,(((cov_0 + cov_00) + cov_1) + cov_01));
...
struct information_diversity_probit_likelihood_functor__ {
    ...
    operator()(const int& N_0,
                                            ...
                                            const T16__& v_0,
                                            const T17__& v_1,
                                            const T18__& rho_01, std::ostream* pstream__) const {
        return information_diversity_probit_likelihood(N_0, N_1, outcome, M_0, M_1, V_0, V_1, C_0, C_1, C_01, mu_star, mu_0, mu_1, gamma_0, gamma_1, rho_0, v_0, v_1, rho_01, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_case_2_1M
  : public stan::model::model_base_crtp<model_case_2_1M> {
private:
        int N;
        std::vector<int> N_0;
        std::vector<int> N_1;
...
public:
    model_case_2_1M(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_case_2_1M_namespace::model_case_2_1M";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                lp_accum__.add(information_diversity_probit_likelihood(get_base1(N_1, i, "N_1", 1), get_base1(N_0, i, "N_0", 1), get_base1(outcome, i, "outcome", 1), get_base1(M_1, i, "M_1", 1), get_base1(M_0, i, "M_0", 1), get_base1(V_1, i, "V_1", 1), get_base1(V_0, i, "V_0", 1), get_base1(C_1, i, "C_1", 1), get_base1(C_0, i, "C_0", 1), get_base1(C_01, i, "C_01", 1), mu_star, mu_1_, mu_0_, gamma_1_, gamma_0_, rho_1_, v_1_, v_0_, rho_01_, pstream__));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_case_2_1M_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_case_2_1M_namespace::model_case_2_1M stan_model;
#ifndef USING_R

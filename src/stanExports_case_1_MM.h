...
namespace model_case_1_MM_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_case_1_MM");
    reader.add_event(114, 112, "end", "model_case_1_MM");
    return reader;
}
template <typename T3__, typename T4__, typename T5__, typename T6__, typename T7__, typename T8__, typename T9__, typename T10__, typename T11__, typename T12__, typename T13__, typename T14__, typename T15__, typename T16__, typename T17__, typename T18__, typename T19__>
typename boost::math::tools::promote_args<T3__, T4__, T5__, T6__, typename boost::math::tools::promote_args<T7__, T8__, T9__, T10__, typename boost::math::tools::promote_args<T11__, T12__, T13__, T14__, typename boost::math::tools::promote_args<T15__, T16__, T17__, T18__, typename boost::math::tools::promote_args<T19__>::type>::type>::type>::type>::type
information_diversity_probit_likelihood(const int& N_0,
                                            ...
                                            const T17__& rho_1,
                                            const T18__& v_1,
                                            const T19__& rho_01, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T3__, T4__, T5__, T6__, typename boost::math::tools::promote_args<T7__, T8__, T9__, T10__, typename boost::math::tools::promote_args<T11__, T12__, T13__, T14__, typename boost::math::tools::promote_args<T15__, T16__, T17__, T18__, typename boost::math::tools::promote_args<T19__>::type>::type>::type>::type>::type local_scalar_t__;
    ...
    try {
        ...
        stan::math::assign(D_0,(v_0 + ((N_0 - 1) * rho_0)));
        ...
        local_scalar_t__ W_1(DUMMY_VAR__);
        (void) W_1;  // dummy to suppress unused var warning
        stan::math::initialize(W_1, DUMMY_VAR__);
        stan::math::fill(W_1, DUMMY_VAR__);
        stan::math::assign(W_1,(W * (rho_1 - v_1)));
        current_statement_begin__ = 14;
        local_scalar_t__ rho_0_i_0(DUMMY_VAR__);
        (void) rho_0_i_0;  // dummy to suppress unused var warning
        stan::math::initialize(rho_0_i_0, DUMMY_VAR__);
        stan::math::fill(rho_0_i_0, DUMMY_VAR__);
        stan::math::assign(rho_0_i_0,(((((N_1 - 1) * rho_0) * rho_1) + (rho_0 * v_1)) - (N_1 * pow(rho_01, 2))));
        ...
        stan::math::assign(rho_0_i,(rho_0_i_0 / W_0));
        ...
        stan::math::assign(delta_0_i,((rho_0_i_0 - W) / W_0));
        current_statement_begin__ = 17;
        local_scalar_t__ rho_1_i_0(DUMMY_VAR__);
        (void) rho_1_i_0;  // dummy to suppress unused var warning
        stan::math::initialize(rho_1_i_0, DUMMY_VAR__);
        stan::math::fill(rho_1_i_0, DUMMY_VAR__);
        stan::math::assign(rho_1_i_0,(((((N_0 - 1) * rho_0) * rho_1) + (rho_1 * v_0)) - (N_0 * pow(rho_01, 2))));
        current_statement_begin__ = 18;
        local_scalar_t__ rho_1_i(DUMMY_VAR__);
        (void) rho_1_i;  // dummy to suppress unused var warning
        stan::math::initialize(rho_1_i, DUMMY_VAR__);
        stan::math::fill(rho_1_i, DUMMY_VAR__);
        stan::math::assign(rho_1_i,(rho_1_i_0 / W_1));
        ...
        stan::math::assign(delta_1_i,((rho_1_i_0 - W) / W_1));
        ...
        stan::math::assign(logdet,((logW + ((N_0 - 1) * stan::math::log((v_0 - rho_0)))) + ((N_1 - 1) * stan::math::log((v_1 - rho_1)))));
        ...
        stan::math::assign(cov_1,(delta_1_i * ((V_1 - ((2 * mu_1) * M_1)) + (N_1 * pow(mu_1, 2)))));
        current_statement_begin__ = 30;
        local_scalar_t__ cov_11(DUMMY_VAR__);
        (void) cov_11;  // dummy to suppress unused var warning
        stan::math::initialize(cov_11, DUMMY_VAR__);
        stan::math::fill(cov_11, DUMMY_VAR__);
        stan::math::assign(cov_11,(rho_1_i * ((C_1 - (((2 * mu_1) * (N_1 - 1)) * M_1)) + ((N_1 * (N_1 - 1)) * pow(mu_1, 2)))));
        ...
        stan::math::assign(cov_01,((2 * rho_01_i) * (((C_01 - ((N_0 * mu_0) * M_1)) - ((N_1 * mu_1) * M_0)) + (((N_0 * N_1) * mu_0) * mu_1))));
        ...
        stan::math::assign(logcov,((((cov_0 + cov_00) + cov_1) + cov_11) + cov_01));
        ...
        stan::math::assign(D_1_i,(delta_1_i + ((N_1 - 1) * rho_1_i)));
        ...
        stan::math::assign(mu_star_cond,((((mu_star + ((gamma_0 * D_0_i) * (M_0 - (N_0 * mu_0)))) + ((gamma_1 * D_1_i) * (M_1 - (N_1 * mu_1)))) + (((gamma_0 * N_0) * rho_01_i) * (M_1 - (N_1 * mu_1)))) + (((gamma_1 * N_1) * rho_01_i) * (M_0 - (N_0 * mu_0)))));
        ...
        stan::math::assign(ssq_star_cond,(((1 - ((N_0 * pow(gamma_0, 2)) * D_0_i)) - ((N_1 * pow(gamma_1, 2)) * D_1_i)) - (((((2 * N_0) * N_1) * gamma_0) * gamma_1) * rho_01_i)));
...
struct information_diversity_probit_likelihood_functor__ {
    ...
    operator()(const int& N_0,
                                            ...
                                            const T17__& rho_1,
                                            const T18__& v_1,
                                            const T19__& rho_01, std::ostream* pstream__) const {
        return information_diversity_probit_likelihood(N_0, N_1, outcome, M_0, M_1, V_0, V_1, C_0, C_1, C_01, mu_star, mu_0, mu_1, gamma_0, gamma_1, rho_0, v_0, rho_1, v_1, rho_01, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_case_1_MM
  : public stan::model::model_base_crtp<model_case_1_MM> {
private:
        int N;
        std::vector<int> N_0;
        std::vector<int> N_1;
...
public:
    model_case_1_MM(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_case_1_MM_namespace::model_case_1_MM";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 69;
        if (!(context__.contains_r("rho_1")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable rho_1 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("rho_1");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "rho_1", "double", context__.to_vec());
        double rho_1(0);
        rho_1 = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, rho_1);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable rho_1: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 70;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 69;
            local_scalar_t__ rho_1;
            (void) rho_1;  // dummy to suppress unused var warning
            if (jacobian__)
                rho_1 = in__.scalar_lb_constrain(0, lp__);
            else
                rho_1 = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 70;
            ...
            local_scalar_t__ rho_1_;
            (void) rho_1_;  // dummy to suppress unused var warning
            stan::math::initialize(rho_1_, DUMMY_VAR__);
            stan::math::fill(rho_1_, DUMMY_VAR__);
            stan::math::assign(rho_1_,(rho_1 / g1));
            ...
            current_statement_begin__ = 97;
            if (stan::math::is_uninitialized(rho_1_)) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: rho_1_";
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable rho_1_: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            current_statement_begin__ = 98;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_case_1_MM_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double rho_1 = in__.scalar_lb_constrain(0);
        vars__.push_back(rho_1);
...
typedef model_case_1_MM_namespace::model_case_1_MM stan_model;
#ifndef USING_R

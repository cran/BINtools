...
namespace model_case_2_M1_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_case_2_M1");
    reader.add_event(108, 106, "end", "model_case_2_M1");
    return reader;
}
...
class model_case_2_M1
  : public stan::model::model_base_crtp<model_case_2_M1> {
private:
        int N;
        std::vector<int> N_0;
        std::vector<int> N_1;
...
public:
    model_case_2_M1(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_case_2_M1_namespace::model_case_2_M1";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_case_2_M1_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_case_2_M1_namespace::model_case_2_M1 stan_model;
#ifndef USING_R
